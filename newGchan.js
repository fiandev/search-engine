...
function ganti(isDark){
  ...
  $("#spinner").toggleClass("spinner-dark");;
  $("#preload").toggleClass("bg-dark");
  if(!isLogin){
...
function showDataLogin(){
  (function($) {
    'use strict';
    $(document).ready(function() {
      let name = [nameLoginValue];
      let age = [ageLoginValue];
      $(function() {
        $("#user").typed({
          strings: name,
          typeSpeed: 1,
...
$("#btnsearch").on("click",function(){
  $("#btnClearResult").toggleClass("d-none");
})
